...
You never reach. If a player's ADP says they should go later, you let them go later and take the sure thing at your current pick. You trust the consensus rankings and take the highest-ranked safe player available. Consistency wins championships over a full season, not one big week. Let other drafters gamble; you will be in the playoffs while they are on the waiver wire.
